        ...
        <x-flex aligns=":center">
          ...
          >
            <x-flex invert colors=":white" width="100%">
              <x-choose name="$test" multi font="base" hf-colors="white:quine" pad="v1 h2">
                <x-option v-for="c in list" #default="{ selected }" :key="c.policyId">
                  <x-flex aligns=":center" align="left">
...
<script>
import { XBackground, XButton, XCheckbox, XChoose, XDropMenu, XFieldset, XFlex, XIcon, XOption, XText } from 'exude'
...
export default
{
    ...
    components: { XBackground, XButton, XCheckbox, XChoose, XDropMenu, XFieldset, XFlex, XIcon, XOption, XText },
